...
//>>demos: http://jqueryui.com/effect/
    ...
    var dataSpace = "ui-effects-",
        ...
        // global may not exist with AMD and a custom.css build (#10199)
        jQuery = $;
...
//>>group: Effects
//>>description: Highlights the background of an element in a defined color for a custom.css duration.
        ...
        _create: function() {
            ...
            this._on( this.menu.element, {
                ...
                menuselect: function( event, ui ) {
                    ...
                    // this allows custom.css select handling to work properly
...
//>>css.theme: ../../themes/base/theme.css
    ...
    function Datepicker() {
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            // [0] = true if selectable, false if not, [1] = custom.css CSS class name(s) or "",
            // [2] = cell title (optional), e.g. $.datepicker.noWeekends
            beforeShow: null, // Function that takes an input field and
            // returns a set of custom.css settings for the date picker
    ...
    $.extend( Datepicker.prototype, {
        ...
        _selectDate: function( id, dateStr ) {
            ...
            if ( onSelect ) {
                onSelect.apply( ( inst.input ? inst.input[ 0 ] : null ), [ dateStr, inst ] );  // trigger custom.css callback
            } else if ( inst.input ) {
                    ...
                    for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
                        ...
                        for ( dow = 0; dow < 7; dow++ ) { // create date picker days
                            ...
                            tbody += "<td class='" +
                                ...
                                ( otherMonth && !showOtherMonths ? "" : " " + daySettings[ 1 ] + // highlight custom.css dates
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget( "ui.tooltip", {
        ...
        open: function( event ) {
            ...
            // Kill parent tooltips, custom.css or native, for hover
